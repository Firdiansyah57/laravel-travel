        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        <b>Sisa Kuota :</b>
                        <strong id="quota-text">{{ $sisaQuota }}</strong> orang
                    </p>
                    ...
                    <div class="trip-dropdown">
                        ...
                        <button class="dropdown-btn" data-toggle="collapse" data-target="#fasilitasList">
                            Tampilkan <i class="fa fa-chevron-down"></i>
                        </button>
        ...
        function checkQuota() {
            fetch('/check-quota/{{ $trip->id }}')
                ...
                .then(data => {
                    ...
                    // update quota text
                    document.getElementById('quota-text').innerText = quota;

                    let btn = document.getElementById('booking-btn');

                    // disable kalau habis
                    if (quota <= 0) {
                        btn.innerText = 'FULL BOOKED';
